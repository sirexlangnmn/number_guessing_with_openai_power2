...
async function startGame() {
  console.log("Welcome FEDEREX POTOLIN to the Number Guessing Game!");
  console.log("Think of a number between 1 and 100.");
  await waitAndPrint(5); // Wait for 5 seconds and print some text
  ...
  while (true) {
    ...
    await waitAndPrint(5); // 5 seconds delay
  }
}

// Function to wait for a specified number of seconds and print some text
async function waitAndPrint(seconds) {
  for (let i = seconds; i > 0; i--) {
    console.log(`AI is thinking... ${i}`);
